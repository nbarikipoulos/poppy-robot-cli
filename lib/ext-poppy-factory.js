...
const createPoppy = async (config) => coreCreatePoppy(configObject.getSettings(config))
const createRequestHandler = async (config) => coreCreateRequesHandler(configObject.getSettings(config))
const createDescriptor = async (config) => coreCreateDescriptor(configObject.getSettings(config))
